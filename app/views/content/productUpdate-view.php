		...
		<div class="columns">
			...
			<div class="column">
				<div class="control">
					...
					<input class="input" type="text" name="producto_precio_compra" value="<?php echo $datos['producto_precio_compra']; ?>" pattern="[0-9.]{1,25}" maxlength="25" value="0.00" required readonly>
				</div>
			</div>
			...
			<div class="column">
				<div class="control">
					<label>Modelo</label>
					<input class="input" type="text" name="producto_modelo" value="<?php echo $datos['producto_modelo']; ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,30}" maxlength="30" readonly>
				</div>
			</div>
			...
			<div class="column">
				<div class="control">
					...
					<input class="input" type="text" name="producto_stock" value="<?php echo $datos['producto_stock_total']; ?>" pattern="[0-9]{1,22}" maxlength="22" required readonly>
				</div>
			</div>
