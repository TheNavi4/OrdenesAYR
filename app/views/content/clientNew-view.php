		...
		<div class="columns">
			<div class="column">
				<div class="control">
					...
					<input class="input" type="text" name="cliente_provincia" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,30}" minlength="3" maxlength="30" required>
				</div>
			</div>
			  <div class="column">
		    	<div class="control">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Color <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input class="input" type="text" name="cliente_ciudad" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{4,30}" maxlength="30" required >
				</div>
		  	</div>
